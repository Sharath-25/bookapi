...
@ComponentScans(value = { @ComponentScan("com.xworkz.book.dao"), @ComponentScan("com.xworkz.book.service") })
public class AppConfig {

	@Autowired
	private Environment env;
	// spring will create object for the above dependency and inject
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		localSessionFactoryBean.setPackagesToScan("com.xworkz.book.entity");
